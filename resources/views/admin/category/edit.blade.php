...
@section('content')
    <div class="right-heade-nav">
        ...
        &raquo;
        <a href="#" class="navbar-link">修改文章分类</a>
    </div>
    ...
    <form action="{{url('admin/category/'.$filed->cate_id)}}" method="post">
        ...
        <table class="table table-bordered type-table">
            <tr>
                ...
                <td>
                    <select name="cate_pid">
                        ...
                        @foreach($data as $d)
                            <option value="{{$d->cate_id}}" @if($d->cate_id==$filed->cate_pid) selected @endif>
                                {{$d->cate_name}}
                            </option>
                        @endforeach
                    </select>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="cate_name" value="{{$filed->cate_name}}" placeholder="请输入分类名称" style="width: 30%;display: inline-block">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" value="{{$filed->cate_title}}" name="cate_title"  placeholder="请输入分类标题" style="width: 60%;display: inline-block">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <textarea class="form-control" rows="3" name="cate_keywords"  placeholder="请输入关键词" style="width: 60%;display: inline-block">{{$filed->cate_keywords}}</textarea>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <textarea class="form-control" rows="3" name="cate_description"  placeholder="请输入描述" style="width: 60%;display: inline-block">{{$filed->cate_description}}</textarea>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="number" class="form-control" name="cate_order" value="{{$filed->cate_order}}"  placeholder="请输入排序" style="width: 15%;display: inline-block">
