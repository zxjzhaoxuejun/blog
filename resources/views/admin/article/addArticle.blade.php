...
@section('content')
    <div class="right-heade-nav">
        ...
        &raquo;
        <a href="#" class="navbar-link">添加文章</a>
    </div>
    ...
    <form action="{{url('admin/article')}}" method="post">
        ...
        <table class="table table-bordered type-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="art_title" value=""  placeholder="请输入文章标题" style="width: 50%;display: inline-block">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="art_editor"  placeholder="请输入编辑名" style="width: 15%;display: inline-block">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="file_upload"  name="art_thumb"  style="display: inline-block" type="file" multiple="true">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="form-control" name="art_tag" placeholder="请输入关键词" style="width: 50%;display: inline-block">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <textarea class="form-control" rows="3" name="art_description"  placeholder="请输入描述" style="width: 60%;display: inline-block"></textarea>
                    </div>
                </td>
            </tr>
            <tr>
